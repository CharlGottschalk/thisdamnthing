---
name: tdt-dev-pii
description: Review exact staged ThisDamnThing source and proposed commit messages for private information before an authorized agent commit, or on direct request.
---

This skill belongs only to this source repository. Resolve the source root from
this canonical `.dev/skills/tdt-dev-pii/SKILL.md`, not the host bridge or shell
