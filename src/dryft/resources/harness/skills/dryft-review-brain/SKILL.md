...
Run `dryft brain candidates` from the workspace root (or use `dryft --workspace
...
After the user decides, run `dryft brain review <id> --decision approve|reject|edit
