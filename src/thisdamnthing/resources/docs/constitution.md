...
Use `/tdt-constitution` to describe how you want agents to work in your workspace.
...
Use chat or say “use ui” for a browser interview. Be explicit about exceptions:
...
Your rules live in `.tdt/CONSTITUTION.md`. They apply to workspace activity,
...
Use `/tdt-constitution` to show your current rules and guide an update. The
